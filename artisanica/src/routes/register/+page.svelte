<div class="flex flex-row w-full h-screen bg-[#F9FAFB] items-center justify-center">
    ...
    <form class="flex flex-col items-center justify-center w-3/8 h-fit p-8 gap-4 bg-[#fff] rounded-lg shadow-lg">
        <h1 class="text-3xl text-[#1F2937] text-center">Create an account</h1>
